...
\usepackage{userstyle}      % include user package (user style)
%===============================================================================
\begin{document}
\begin{frontmatter}
...
\thanks[footnoteinfo]{This work was supported by the Ministry of Science and Higher Education of the Russian Federation under Project Goszadanie under Grant 2019-0898.}


\author[First]{D. Gerasimov}
\author[First]{V. Nikiforov}
% \author[Second]{Second B. Author, Jr.}
% \author[Third]{Third C. Author}

\address[First]{ITMO University, Kronverkskiy av. 49, Saint Petersburg, 197101, Russia (e-mails: dngerasimov@corp.ifmo.ru, nikiforov\_vo@itmo.ru).}
...
\begin{ack}
This work was supported by the Ministry of Science and Higher Education of the Russian Federation according to the research project (Goszadanie) no.2019-0898.
\end{ack}
